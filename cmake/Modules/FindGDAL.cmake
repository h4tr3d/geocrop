...
if(WIN32)	
  ...
  mark_as_advanced(GDAL_INCLUDE_DIRS GDAL_LIBRARIES GDAL_DEFINITIONS)
...
if (NOT TARGET GDAL::gdal)
  ...
  set_target_properties(GDAL PROPERTIES
      INTERFACE_COMPILE_OPTIONS "${GDAL_DEFINITIONS}"
      INTERFACE_INCLUDE_DIRECTORIES ${GDAL_INCLUDE_DIRS}
      INTERFACE_LINK_LIBRARIES "${GDAL_LIBRARIES}"
      #INTERFACE_LINK_DIRECTORIES "${GDAL_LIBRARY_DIRS}"
      )
